...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return new Promise(function (resolve) { resolve(require(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-c8712ff0.js')); }).then(() => {
...
const patchBrowser = () => {
    ...
    }
    {
        ...
        if ( !win.customElements) {
            ...
            // @ts-ignore
            return new Promise(function (resolve) { resolve(require(/* webpackChunkName: "polyfills-dom" */ './dom-a024abe6.js')); }).then(() => opts);
        }
    }
