...
(function(s){s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='fudgeapps']"));
...
var createDomApi = function(App, win, doc) {
  ...
  var domApi = {
    ...
    $addEventListener: function(assignerElm, eventName, listenerCallback, useCapture, usePassive, attachTo, eventListenerOpts, splt, assignersEventName) {
      ...
      // keyup.enter
      eventName = splt[0], eventListener = function(ev) {
...
var updateAttribute = function(elm, memberName, newValue, isBooleanAttr, isXlinkNs) {
  ...
  null == newValue || isBooleanAttr && (!newValue || 'false' === newValue) ? isXlinkNs ? elm.removeAttributeNS(XLINK_NS$1, toLowerCase(memberName)) : elm.removeAttribute(memberName) : 'function' !== typeof newValue && (newValue = isBooleanAttr ? '' : newValue.toString(), 
...
var initHostSnapshot = function(domApi, cmpMeta, hostElm, hostSnapshot, attribName) {
  ...
  domApi.$supportsShadowDom || 1 /* ShadowDom */ !== cmpMeta.encapsulationMeta || !window.HTMLElement || 'shadowRoot' in window.HTMLElement.prototype || (hostElm.shadowRoot = hostElm), 
        ...
        (function(plt, cmpMeta, hostElm, instance, perf) {
          try {
            ...
            if (instance.render || instance.hostData || hostMeta || reflectHostAttr) {
              ...
              plt.vnodeMap.set(hostElm, plt.render(hostElm, oldVNode, hostVNode, false, encapsulation));
            }
            // update styles!
...
needShim = true), needShim && (customStyle = new CustomStyle(w, d)), function createPlatformMainLegacy(namespace, Context, win, doc, resourcesUrl, hydratedCssClass, components, customStyle) {
  ...
  function requestComponentBundle(bundleId, hmrVersionId) {
    var url = resourcesUrl + bundleId + '.es5.entry.js';
